...
Data Preprocessing: 256×256 normalization, paired image loading
Model Architecture: Encoder-decoder U-Net with concatenated skip connections
Training Strategy: Early stopping, learning rate reduction, model checkpointing
Evaluation: Comprehensive metrics with train/val curves
...
City Risk: Try "Mumbai", "Patna", "Delhi"
Image Analysis: Upload pre/post flood image pairs
API Demo: Run demo button for sample predictions
API Testing:
# Health check
